...
class ProtoLobe extends Neuron
{
	...
	react(input)
	{
		...
		if( "Command" in input )
		{
			this.rfcomm.send("S", input.Command.Rotunda);
			this.rfcomm.send("S", input.Command.Shoulder);
			this.rfcomm.send("S", input.Command.Elbow);
			this.rfcomm.send("S", input.Command.Wrist_Pitch);
			this.rfcomm.send("S", input.Command.Wrist_Roll);
			this.rfcomm.send("S", input.Command.Claw);
			this.rfcomm.send("S", input.Command.Camera_Select);
			this.rfcomm.send("S", input.Command.Rotunda_Camera);
			return true;
		}
