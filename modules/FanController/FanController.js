...
class FanController extends Neuron {
    ...
    writeTempLimits(UPPER_TEMP,LOWER_TEMP) {
        ...
        //For Unittesting
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x45)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x47)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x49)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x4B)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x4D)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x4F)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x51)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x53)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x55)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x57)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x44)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x46)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x48)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x4A)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x4C)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x4E)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x50)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x52)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x54)));
        this.TEMPLIMIT.push(this.decodeTEMP(i2c.readByte(0x2C,0x56)));
